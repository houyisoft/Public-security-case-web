    ...
    <v-stage :config="configKonva">
        <v-layer ref="layer">
            ...
            >
                <v-circle
                    :config="{
                    name: 'resetCircle', x: 100, y: 100, radius: 30, fill: indexList[8] ? '#6c7df9' : '#232426', stroke: '#1B1D1F', strokeWidth: 1 }"
                />
                <v-image :config="{ name: 'resetImage', x: 84, y: 84, image: images.reset }" />
            </v-group>
            <!-- 近 -->
            <v-group
                name="near"
            ...
            >
                <v-circle
                    :config="{
                    name: 'nearCicle', radius: 28, fill: indexList[9] ? '#6c7df9' : '#232426', stroke: '#1B1D1F', strokeWidth: 1 }"
                />
                <v-image
                    :config="{
                    name: 'nearImage', x: -12, y: -12, width: 24, height: 24, image: images.near }"
                />
            </v-group>
            <!-- 远 -->
            <v-group
            ...
            >
                <v-circle
                    :config="{
                    name: 'farCicle', radius: 28, fill: indexList[10] ? '#6c7df9' : '#232426', stroke: '#1B1D1F', strokeWidth: 1 }"
                />
                <v-image
                    :config="{
                    name: 'farImage', x: -12, y: -12, width: 24, height: 24, image: images.far }"
                />
            </v-group>
        </v-layer>
    </v-stage>
