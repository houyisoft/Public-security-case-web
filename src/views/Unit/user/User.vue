<template>
	<div class="system-administration">
		...
		<!-- 主页弹窗 -->
		<base-dialog :isBaseDialog="mainDialog"
		 ...
		 @onPostBaseDialogFormData="postBaseDialogFormData">
			...
			<el-row>
					<el-col :span="12">
						<el-form-item :rules="[{'required': true,'message': '请输入公司名称','trigger': 'blur'}]" label="公司名称" prop="name">
							<el-input class="input-width" v-model="baseTopFormData.type"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item :rules="[{'required': true,'message': '请输入公司性质','trigger': 'blur'}]" label="公司性质" prop="name">
							<el-input class="input-width" v-model="baseTopFormData.type"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item :rules="[{'required': true,'message': '请输入公司编码','trigger': 'blur'}]" label="公司编码" prop="name">
							<el-input class="input-width" v-model="baseTopFormData.type"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item :rules="[{'required': true,'message': '请输入公司简称','trigger': 'blur'}]" label="公司简称" prop="name">
							<el-input class="input-width" v-model="baseTopFormData.type"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item  label="上级公司" prop="name">
							<el-select placeholder="请选择"
								v-model="baseTopFormData.type">
								<el-option :value="item.value"
								:label="item.label"
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="公司地点" prop="name">
							<el-input class="input-width" v-model="baseTopFormData.type"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="精英范围" prop="name">
							<el-input  v-model="baseTopFormData.type"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
	...
	export default {
		...
		methods: {
			postBaseDialogFormData() {
				console.log('提交表单数据',JSON.parse(JSON.stringify(this.baseTopFormData)))
			},
			// 主页表单校验并保存按钮
			submitForm(formName) {
